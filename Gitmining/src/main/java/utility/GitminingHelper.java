...
public class GitminingHelper {
	...
	public static void main(String[] args){
		GitminingHelper.getInstance().initData();
	}
	...
	public void initData() {
		...
		String[] names = info.substring(1, info.length() - 1).replaceAll("\"", "").split(",");
	...
	private void saveUser(String userName) {
		String info = GitminingHelper.sendGet("https://api.github.com/users/hanifor" + userName);
	...
	private void saveRepo(String fullName) {
		String info = GitminingHelper.sendGet("http://gitmining.net/api/repository/" + fullName);
